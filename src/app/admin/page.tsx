      ...
      {tab === 'events' && (
        <div className="bg-white/50 dark:bg-slate-900/40 border border-slate-200 dark:border-white/10 rounded-2xl p-8 max-w-2xl mx-auto">
          ...
          <form onSubmit={handleCreateEvent} className="space-y-5 text-slate-900 dark:text-white">
            ...
            <div className="pt-4">
              <button disabled={isCreatingEvent} type="submit" className="w-full py-4 bg-indigo-600 dark:bg-white dark:text-slate-900 dark:shadow-none  text-white rounded-xl font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
