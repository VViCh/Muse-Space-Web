        ...
        <div className="shrink-0 flex flex-col items-end gap-2">
          ...
          {!isArtist && c.status === 1 && (
            <button 
              ...
              className="text-xs font-bold text-white bg-indigo-500 hover:bg-indigo-600 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200 dark:shadow-none px-3 py-1.5 rounded-lg flex items-center gap-1 shadow-md shadow-indigo-500/20 transition-colors"
            >
    ...
    <div className="min-h-screen pb-16 animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            ...
            <Link
              href="/commissions"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200 dark:shadow-none text-white rounded-xl font-bold shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:scale-[1.02] transition-all text-sm"
            >
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 bg-white/50 dark:bg-slate-900/30 border border-dashed border-slate-300 dark:border-white/10 rounded-3xl text-center">
              ...
              {activeTab === 'requested' && (
                <Link href="/commissions" className="mt-5 px-6 py-2.5 bg-indigo-600 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200 dark:shadow-none text-white rounded-xl font-bold text-sm transition-all shadow-[0_0_15px_rgba(79,70,229,0.3)]">
                  Browse Artists
                </Link>
              )}
            </div>
