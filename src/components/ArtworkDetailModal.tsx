            ...
            {hasImageError ? (
              <div className="flex flex-col items-center justify-center text-slate-400 gap-4">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-indigo-600 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200 dark:shadow-none text-white rounded-xl hover:bg-indigo-500 font-bold transition-colors flex items-center gap-2"
                >
